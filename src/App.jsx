...
const STEPS = ['router', 'security', 'report', 'fix', 'verify'];
  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {step === 4 && (
          <VerifyStep
            onRestart={() => { setBrand(null); setSecType(null); go(0); }}
          />
        )}
      </main>
      ...
      <footer className="app-footer">
        ...
        <p>
          <a href="https://github.com/yourusername/sa-wifi-guard" target="_blank" rel="noreferrer">GitHub</a>
          {' · '}
